...
let totalMines; // store original mine count
let board = [];
let gameOver = false;
let timer = 0;
let interval;
    ...
    for (let r = 0; r < rows; r++) {
        ...
        for (let c = 0; c < cols; c++) {
            ...
            div.addEventListener("touchend", (e) => {
                ...
                // If long press happened, stop click from firing
                if (isLongPress) {
                    e.preventDefault();
                    e.stopPropagation();
                }
...
function handleClick(e) {
    ...
    if (cell.flagged) return; // ✅ prevent revealing flagged
